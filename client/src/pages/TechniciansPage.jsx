...
// Одна операция удаления: «Удалить» = удалить строку из technicians и (если есть) учётку Auth.
              ...
              {filteredRows().map((row) => (
                <tr key={row.id}>
                  ...
                  <td className="row-inline" style={{ flexWrap: 'wrap' }}>
                    <button className="btn" onClick={() => onDelete(row)} title="Удалить запись и учётку Auth">Удалить</button>
                  </td>
                </tr>
              ))}

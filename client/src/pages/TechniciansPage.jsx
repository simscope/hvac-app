...
export default function AdminTechniciansPage() {
  ...
  async function deleteTech(row) {
    if (!window.confirm(`Удалить сотрудника "${row.name}"?`)) return;
    setLoading(true);
    try {
      ...
      <div className="two-cols">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="row-inline">
                    <button className="btn" disabled={loading} type="submit">{loading ? "Создаю..." : "Создать сотрудника"}</button>
        ...
        <div className="col-right">
          <div className="row-inline" style={{ marginBottom: 8 }}>
            ...
            <button className="btn" onClick={fetchTechnicians}>Обновить</button>
          </div>

          <table className="table">
            <thead><tr><th>Имя</th><th>E-mail</th><th>Телефон</th><th>Роль</th><th>Действия</th></tr></thead>
            <tbody>
